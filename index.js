...
export const burger = {
  ...
  discount: function (string) {
    switch (string) {
      case ('teacher'): return 13.5;
      case ('student'): return 13.5;
      case ('public'): return 16.2;
    }
  }
};
...
console.log(reviews[reviews.findIndex(index => index.name === 'Julius')].feedback);
...
reviews.push({ name: 'John', rating: 2.5, feedback: 'It was a decent experience.' });
...
reviews[reviews.findIndex(index => index.name === 'Reyna')].feedback = "this place is chill with really cool people, great for getting work done on weekdays";
...
function getLastReview(array) {
  ...
  const { name, rating, feedback } = index;
...
function getReviewByRating(array, rating) {
  ...
  for (let i = 0; i < array.length; i++) {
    if (array[i].rating.toString().startsWith(rating)) {
...
console.log('Create', car1.odometer);

console.log('Update', car1.drive(100));
